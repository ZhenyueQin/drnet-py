...
parser.add_argument('--model_path', default='./logs/kth64x64/2019-01-18-17-37-04/content_model=dcgan_unet-pose_model=dcgan-content_dim=128-pose_dim=20-max_step=20-sd_weight=0.000-lr=0.002-sd_nf=100-normalize=False', help='path to drnet model')
